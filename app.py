...
def calculate_logic(df_db):
    ...
    # Vorjahresbasis für jeden Monat der Timeline
    ...
    # Zukunft mit letztem Trend auffüllen
...
try:
    ...
    if not df_res.empty:
        ...
        fig.update_layout(separators=".,", hovermode="x unified", margin=dict(l=5, r=5, t=10, b=10), yaxis=dict(title="€"), xaxis=dict(tickformat="%b %y"))
